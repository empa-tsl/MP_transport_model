...
rivers.all5$length_seconds <- rivers.all5$length_m/rivers.all5$flow_velocity # this factor can be used for mulitplay the concMSV (see below) and get masses per section
