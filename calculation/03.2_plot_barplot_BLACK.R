...
nice <- theme_classic()+
				theme(legend.position = "none",
							...
							axis.text.x = element_text(color = "white", face = "plain", size = 7),
							axis.text.y = element_text(color = "white", face = "plain", size = 7),
...
p1 <- ggplot(data=df01_total[df01_total$compartment == "outflow", ], aes(x=scenario, y=value, fill=scenario)) +
	...
	geom_text(aes(label= round(value,1)), vjust=-0.8, color="white",
...
legende <- ggplot(data=l, aes(x=river, y=value, fill=polymer)) +
	...
	geom_text(aes(y = pos, label = rev(polymer)), color = c( "white"),size = 2)+
	...
	theme(plot.margin=unit(c(1.5,0,0.5,0),"cm"),
				...
				panel.ontop = F,
				plot.subtitle = element_text(size = 7, color = "white"),
...
ggsave(paste0(main.path, "output_files/plots/black/outflow2.png"), p211, width = 12, height = 8, units = "cm", dpi = 500, bg = "transparent")

# ggsave(paste0(main.path, "output_files/plots/black/outflow2.pdf"), p211, width = 9, height = 6, units = "cm", dpi = 500, bg = "transparent")
...
pall
ggsave(paste0(main.path, "output_files/plots/black/outflow_acc.png"), pall, height = 8.5, width = 17, units = "cm", dpi = 500, bg = "transparent")

ggsave(paste0(main.path, "output_files/plots/black/outflow.png"), p1, width = 8, height = 8, units = "cm", dpi = 500, bg = "transparent")

ggsave(paste0(main.path, "output_files/plots/black/outflow.pdf"), p1, width = 8, height = 8, units = "cm", dpi = 500, bg = "transparent")
